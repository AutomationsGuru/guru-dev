...
export type CommentTaskMarker = z.infer<typeof CommentTaskMarkerSchema>
...
const DEFAULT_MARKERS: readonly CommentTaskMarker[] = Object.freeze([
 ...
 */
function buildMarkerPattern(marker: CommentTaskMarker): RegExp {
 ...
 */
function trimTrailingCloser(text: string): string {
  return text.replace(/\s*(?:\*\/|-->)\s*$/u, '').trimEnd()
}

export function defaultMarkers(): readonly CommentTaskMarker[] {
